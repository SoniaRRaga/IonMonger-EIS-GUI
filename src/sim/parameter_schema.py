...
SCHEMA: tuple[ParameterField, ...] = (
    ...
    ParameterField("jv_v_start", "JV start voltage (V)", "EIS settings", "float", 1.2, "Starting voltage for JV sweep protocol."),
    ParameterField("jv_v_end", "JV end voltage (V)", "EIS settings", "float", 0.0, "Intermediate JV voltage before return sweep."),
    ParameterField("jv_scan_rate", "JV scan rate (V/s)", "EIS settings", "float", 0.1, "Scan rate used to build linear JV sections."),
